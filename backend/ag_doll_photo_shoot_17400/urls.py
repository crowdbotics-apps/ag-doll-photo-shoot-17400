"""ag_doll_photo_shoot_17400 URL Configuration
...
admin.site.site_header = "AG Doll Photo-Shoots"
admin.site.site_title = "AG Doll Photo-Shoots Admin Portal"
admin.site.index_title = "AG Doll Photo-Shoots Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="AG Doll Photo-Shoots API",
        default_version="v1",
        description="API documentation for AG Doll Photo-Shoots App",
    ),
    public=True,
